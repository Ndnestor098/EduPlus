                            ...
                            @foreach ($students as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="hidden" name="students[{{ $item->id  }}][id]" value="{{ $item->id }}">
                                        <input type="number" name="students[{{ $item->id }}][note]" 
                                            @if($item->works[0]->qualification)
                                                value="{{$item->works[0]->qualification}}" 
